        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              APL Tickets — официальный продавец билетов на матчи Английской Премьер-Лиги в России. Мы работаем напрямую с клубами и проверенными партнёрами, поэтому каждый билет гарантированно подлинный.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              За 8 лет мы помогли более 25 000 болельщиков попасть на главные матчи Англии — от рядовых туров до финалов Кубка. Ваш футбол начинается здесь.
            </p>
          </div>
        </div>
      </div>
